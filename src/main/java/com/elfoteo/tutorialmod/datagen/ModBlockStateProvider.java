...
import com.elfoteo.tutorialmod.block.custom.BismuthLampBlock;
import com.elfoteo.tutorialmod.block.custom.GojiBerryBushBlock;
import com.elfoteo.tutorialmod.block.custom.RadishCropBlock;
...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    private void blockItem(DeferredBlock<?> deferredBlock) {
        simpleBlockItem(deferredBlock.get(),
                new ModelFile.UncheckedModelFile("tutorialmod:block/" + deferredBlock.getId().getPath()));
    }
    private void blockItem(DeferredBlock<?> deferredBlock, String appendix) {
        simpleBlockItem(deferredBlock.get(),
                new ModelFile.UncheckedModelFile("tutorialmod:block/" + deferredBlock.getId().getPath() + appendix));
    }
}
