package com.elfoteo.tutorialmod.entity;
import com.elfoteo.tutorialmod.TutorialMod;
import com.elfoteo.tutorialmod.entity.custom.ChairEntity;
import com.elfoteo.tutorialmod.entity.custom.GeckoEntity;
import com.elfoteo.tutorialmod.entity.custom.TomahawkProjectileEntity;
...
public class ModEntities {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister
            .create(BuiltInRegistries.ENTITY_TYPE, TutorialMod.MOD_ID);
