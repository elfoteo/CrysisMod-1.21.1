package com.elfoteo.tutorialmod.enchantment;
import com.mojang.serialization.MapCodec;
import com.elfoteo.tutorialmod.TutorialMod;
import com.elfoteo.tutorialmod.enchantment.custom.LightningStrikerEnchantmentEffect;
...
public class ModEnchantmentEffects {
    public static final DeferredRegister<MapCodec<? extends EnchantmentEntityEffect>> ENTITY_ENCHANTMENT_EFFECTS = DeferredRegister
            .create(Registries.ENCHANTMENT_ENTITY_EFFECT_TYPE, TutorialMod.MOD_ID);
