package com.elfoteo.crysis.compat;
...
import com.elfoteo.crysis.recipe.GrowthChamberRecipe;
...
public class GrowthChamberRecipeCategory implements IRecipeCategory<GrowthChamberRecipe> {
    public static final ResourceLocation UID = ResourceLocation.fromNamespaceAndPath(CrysisMod.MOD_ID,
            "growth_chamber");
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(CrysisMod.MOD_ID,
            "textures/gui/growth_chamber/growth_chamber_gui.png");
    public static final RecipeType<GrowthChamberRecipe> GROWTH_CHAMBER_RECIPE_RECIPE_TYPE = new RecipeType<>(UID,
            GrowthChamberRecipe.class);
    ...
    public Component getTitle() {
        return Component.translatable("block.crysis.growth_chamber");
    }
