package com.elfoteo.crysis.item.custom;
...
public class ChiselItem extends Item {
        ...
        if (CHISEL_MAP.containsKey(clickedBlock)) {
            if (!level.isClientSide()) {
                ...
                ((ServerLevel) level).sendParticles(
                        new BlockParticleOption(ParticleTypes.BLOCK, clickedBlock.defaultBlockState()),
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents,
        ...
        if (Screen.hasShiftDown()) {
            tooltipComponents.add(Component.translatable("tooltip.crysis.chisel.shift_down"));
        } else {
            tooltipComponents.add(Component.translatable("tooltip.crysis.chisel"));
        }
        if (stack.get(ModDataComponents.COORDINATES) != null) {
            tooltipComponents
                    .add(Component.literal("Last Block changed at " + stack.get(ModDataComponents.COORDINATES)));
        }
