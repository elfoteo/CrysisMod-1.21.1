...
public class SolidColoredVertexConsumer implements VertexConsumer {
    ...
    public SolidColoredVertexConsumer(VertexConsumer delegate, int r, int g, int b, int a) {
