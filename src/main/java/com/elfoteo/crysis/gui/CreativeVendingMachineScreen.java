...
public class CreativeVendingMachineScreen extends AbstractContainerScreen<CreativeVendingMachineMenu> {
    private static final ResourceLocation GUI_TEXTURE   = ResourceLocation.fromNamespaceAndPath(CrysisMod.MOD_ID, "textures/gui/trades.png");
    private static final ResourceLocation SLOT_TEXTURE  = ResourceLocation.fromNamespaceAndPath(CrysisMod.MOD_ID, "textures/gui/slot.png");
    private static final ResourceLocation ARROW_TEXTURE = ResourceLocation.fromNamespaceAndPath(CrysisMod.MOD_ID, "textures/gui/arrow_progress.png");
